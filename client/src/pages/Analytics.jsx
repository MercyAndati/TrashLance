    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-4 sm:py-8">
      <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8">
        ...
        <div className="mb-4 sm:mb-6">
          <div className="flex flex-wrap gap-2 sm:space-x-2">
            <button
              ...
              className={`flex-1 sm:flex-none px-3 py-2 sm:px-4 sm:py-2 rounded-lg text-xs sm:text-sm font-medium transition-colors min-w-0 ${
                timeframe === "week"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-6 mb-6 sm:mb-8">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700 p-4 sm:p-6">
            <div className="flex items-center justify-between">
              ...
              <DollarSign className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 text-green-600 dark:text-green-400 flex-shrink-0" />
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700 p-4 sm:p-6">
            <div className="flex items-center justify-between">
              ...
              <Calendar className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 text-blue-600 dark:text-blue-400 flex-shrink-0" />
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700 p-4 sm:p-6">
            <div className="flex items-center justify-between">
              ...
              <Star className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 text-yellow-600 dark:text-yellow-400 flex-shrink-0" />
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700 p-4 sm:p-6">
            <div className="flex items-center justify-between">
              ...
              <Activity className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 text-purple-600 dark:text-purple-400 flex-shrink-0" />
            </div>
          </div>
        </div>
                  ...
                  <div className="flex items-center space-x-2 sm:space-x-4 min-w-0 flex-1 justify-end">
                    ...
                    <div className="w-16 sm:w-24 bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                      <div 
                        ...
                        style={{ width: `${earningsData.length > 0 ? (item.earnings / Math.max(...earningsData.map(d => d.earnings))) * 100 : 0}%` }}
                      ></div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex items-center space-x-2 sm:space-x-4 min-w-0 flex-1 justify-end">
                    ...
                    <div className="w-16 sm:w-24 bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                      <div 
                        ...
                        style={{ width: `${earningsData.length > 0 ? (item.bookings / Math.max(...earningsData.map(d => d.bookings))) * 100 : 0}%` }}
                      ></div>
                    </div>
                  </div>
                </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-6 sm:mb-8">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700 p-4 sm:p-6">
            ...
            <div className="space-y-2 sm:space-y-3">
              <div className="flex justify-between items-center">
                ...
                <span className="text-xs sm:text-sm font-medium text-gray-900 dark:text-white">KSh 2,000</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">Current Progress</span>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700 p-4 sm:p-6 md:col-span-2 lg:col-span-1">
            <div className="flex items-center space-x-2 sm:space-x-3 mb-3 sm:mb-4">
            ...
            <div className="space-y-2 sm:space-y-3">
              <div className="flex justify-between items-center">
                <span className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">Avg. Booking Value</span>
                <span className="text-xs sm:text-sm font-medium text-gray-900 dark:text-white">
                  ${stats.bookings > 0 ? Math.round((stats.monthlyEarnings || 0) / stats.bookings) : 0}
                </span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">Response Time</span>
                <span className="text-xs sm:text-sm font-medium text-gray-900 dark:text-white">2.3 hrs</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">Completion Rate</span>
                <span className="text-xs sm:text-sm font-medium text-green-600 dark:text-green-400">98%</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700 p-4 sm:p-6">
          <h3 className="text-base sm:text-lg font-semibold text-gray-900 dark:text-white mb-3 sm:mb-4">Recent Bookings</h3>
          <div className="space-y-3 sm:space-y-4">
            {recentBookings.length === 0 ? (
              <p className="text-gray-500 dark:text-gray-400 text-center py-4 text-sm">No recent bookings</p>
            ) : (
