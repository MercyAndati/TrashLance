...
import { Bell, Shield, User, Globe, Moon, Sun, Smartphone, Mail, Eye, EyeOff, ArrowLeft, Menu } from "lucide-react"
...
const Settings = () => {
  ...
  const renderProfileSettings = () => (
    <div className="space-y-4 sm:space-y-6">
      <div>
        <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-3 sm:mb-4">Profile Information</h3>
        <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-3 sm:p-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
            ...
            <div>
              ...
              <p className="text-gray-900 dark:text-white text-sm sm:text-base break-all">{user.email}</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-gray-900 dark:text-white capitalize text-sm sm:text-base">{user.role?.replace("_", " ")}</p>
            </div>
          </div>
          <div className="mt-4">
      ...
      <div>
        <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-3 sm:mb-4">Account Statistics</h3>
  ...
  const renderNotificationSettings = () => (
    <div className="space-y-4 sm:space-y-6">
      <div>
        <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-3 sm:mb-4">Notification Preferences</h3>
        <div className="space-y-3 sm:space-y-4">
          <div className="flex items-center justify-between p-3 sm:p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
            ...
            <label className="relative inline-flex items-center cursor-pointer flex-shrink-0">
              ...
              />
              <div className="w-9 h-5 sm:w-11 sm:h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-green-300 dark:peer-focus:ring-green-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-4 after:w-4 sm:after:h-5 sm:after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-green-600"></div>
            </label>
          </div>
      ...
      <div>
        <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-3 sm:mb-4">Notification Types</h3>
        <div className="space-y-3 sm:space-y-4">
          <div className="flex items-center justify-between p-3 sm:p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
  ...
  const renderSecuritySettings = () => (
    <div className="space-y-4 sm:space-y-6">
      <div>
        <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-3 sm:mb-4">Change Password</h3>
        <form onSubmit={handlePasswordChange} className="space-y-3 sm:space-y-4">
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-3 py-2 sm:px-4 sm:py-3 pr-10 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent text-sm sm:text-base"
                required
              />
              <button
                type="button"
          ...
          <button 
            type="submit" 
            disabled={loading} 
            className="w-full sm:w-auto px-4 py-2 sm:py-3 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors disabled:opacity-50 text-sm sm:text-base"
          >
      ...
      <div>
        <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-3 sm:mb-4">Account Security</h3>
        <div className="space-y-3 sm:space-y-4">
          <div className="flex items-center justify-between p-3 sm:p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
            <div className="flex-1 min-w-0">
            ...
            <button className="px-3 py-1.5 sm:px-4 sm:py-2 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors text-sm">
              Enable
            </button>
          </div>
  ...
  const renderPreferences = () => (
    <div className="space-y-4 sm:space-y-6">
      <div>
        <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-3 sm:mb-4">Appearance</h3>
        <div className="space-y-3 sm:space-y-4">
          <div className="flex items-center justify-between p-3 sm:p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
            <div className="flex items-center space-x-3 flex-1 min-w-0">
            ...
            <button 
              onClick={toggleTheme} 
              className="px-3 py-1.5 sm:px-4 sm:py-2 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors text-sm flex-shrink-0"
            >
              {isDark ? "Light" : "Dark"}
            </button>
          </div>
      ...
      <div>
        <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-3 sm:mb-4">Language & Region</h3>
        <div className="space-y-3 sm:space-y-4">
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Language</label>
            <select className="w-full px-3 py-2 sm:px-4 sm:py-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent text-sm sm:text-base">
      ...
      <div>
        <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-3 sm:mb-4">Data & Privacy</h3>
        <div className="space-y-3 sm:space-y-4">
          ...
          <button
            className="w-full text-left p-3 sm:p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg hover:bg-red-100 dark:hover:bg-red-900/30 transition-colors"
        ...
        <div className="max-w-4xl mx-auto px-3 sm:px-4 lg:px-8">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700 overflow-hidden">
            <div className="flex flex-col sm:flex-row">
              {/* Desktop Sidebar */}
              <div className="hidden sm:block w-1/4 bg-gray-50 dark:bg-gray-700 border-r border-gray-200 dark:border-gray-600">
