              ...
              {user ? (
                <>
                  ...
                  <div className="relative">
                    ...
                    {showNotifications && (
                      <>
                        ...
                        <div className="fixed inset-0 flex items-center justify-center z-50 md:hidden">
                          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl border border-gray-200 dark:border-gray-700 w-[90vw] max-w-[400px] max-h-[70vh] flex flex-col">
                    ...
                    {showNotifications && (
                      <div className="hidden md:block absolute right-0 mt-2 w-80 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 z-50">
                        <div className="p-4 border-b border-gray-200 dark:border-gray-700">
                          <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Notifications</h3>
                        </div>
