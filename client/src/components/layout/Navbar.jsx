            ...
            {user ? (
              <>
                ...
                <div className="relative">
                  ...
                  {showNotifications && (
                    <div className="absolute right-0 sm:right-auto sm:left-auto left-1/2 sm:transform-none transform -translate-x-1/2 mt-2 w-80 sm:w-80 w-[calc(100vw-2rem)] max-w-sm bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 z-50">
